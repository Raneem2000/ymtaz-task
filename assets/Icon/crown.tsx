...
const Crown = () => {
  return (
    ...
    >
      <g filter="url(#filter0_dd_1_261)">
        <rect
          x="4.8924"
          y="0.322571"
          width="14"
          height="14"
          fill="url(#pattern0_1_261)"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1_261"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_1_261"
            result="effect2_dropShadow_1_261"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
        ...
        <pattern
          ...
          height="1"
        >
          <use xlinkHref="#image0_1_261" transform="scale(0.00195312)" />
        </pattern>
        <image
          id="image0_1_261"
          width="512"
